...
public class TickHistory
{
    ...
    internal static void RestoreTickHeader(ref TickHistoryHeader day, ref TickHeader tick)
    {
        ...
        tick.SendingTimestamp = new Timestamp(tick.ExchangeTimestamp.NanosSinceEpoch + tick.SendingTimestamp.NanosSinceEpoch);
    ...
    {
        tick.SendingTimestamp = tick.SendingTimestamp.Max(tick.ExchangeTimestamp);
        ...
        Timestamp sendingTimestamp = new Timestamp(tick.SendingTimestamp.NanosSinceEpoch - tick.ExchangeTimestamp.NanosSinceEpoch);
        ...
        tick.SendingTimestamp = sendingTimestamp;
