...
public struct TickHeader(TickType tickType, int instrumentId, Timestamp exchangeTimestamp, Timestamp sendingTimestamp, Timestamp nicTimestamp)
{
...
public struct Trade
{
    ...
    public Trade(int instrumentId, Timestamp exchangeTimestamp, Timestamp sendingTimestamp, Timestamp nicTimestamp, int ticks, int quantity, sbyte direction)
    {
        TickHeader = new(TickType.Trade, instrumentId, exchangeTimestamp, sendingTimestamp, nicTimestamp);
        Level.Ticks = ticks;
...
public struct MarketByPrice
{
    ...
    public int BidsCount;
    public int AsksCount;
    public MarketByPrice(TickType mbpType, int instrumentId, Timestamp exchangeTimestamp, Timestamp sendingTimestamp, Timestamp nicTimestamp, int bidsCount, int asksCount)
    {
        ...
        TickHeader = new TickHeader(mbpType, instrumentId, exchangeTimestamp, sendingTimestamp, nicTimestamp);
        BidsCount = bidsCount;
        AsksCount = asksCount;
    }
    ...
    public static ref MarketByPrice SnapshotAsUpdate(ReadOnlySpan<byte> past, ReadOnlySpan<byte> future, Span<byte> dst)
    {
        ...
        updateMbp.TickHeader = new TickHeader(
            ...
            futureMbp.TickHeader.SendingTimestamp,
